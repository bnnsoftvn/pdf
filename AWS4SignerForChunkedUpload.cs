...
namespace Bnnsoft.Sdk.Signers
{
    ...
    class AWS4SignerForChunkedUpload : AWS4SignerBase
    {
        ...
        const string CLRF = "\r\n";
        const string CHUNK_STRING_TO_SIGN_PREFIX = "AWS4-HMAC-SHA256-PAYLOAD";
        const string CHUNK_SIGNATURE_HEADER = ";chunk-signature=";
        ...
        public byte[] ConstructSignedChunk(long userDataLen, byte[] userData)
        {
            ...
            {
                throw new SignHMacException("Unable to sign the chunked data. " + e.Message, e);
            }
        }
    }
}
