...
#pragma warning restore DE0004 // API is deprecated
    {
        ...
        public SignClient(string apiId, string secret, string service, string region)
        {
            ...
            //endpointUri = "https://127.0.0.1:44336";
        ...
        protected override WebRequest GetWebRequest(Uri address)
        {
            ...
            var buf = Encoding.UTF8.GetBytes(this.prebuf);
            // precompute hash of the body content
            var contentHash = AWS4SignerBase.CanonicalRequestHashAlgorithm.ComputeHash(buf);
